...
const CardCategory = ({url,img,title,des}) => {
  return (
    <Link href={url} className="flex-[170px] lg:flex-grow-0 lg:w-[19%] lg:flex-[19%] bg-white p-3 rounded-xl">
      <Image src={img} className="rounded-lg !w-full !aspect-video" alt="" width={300} height={300} />
